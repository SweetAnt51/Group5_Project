...
export default function ApplicationFormTests(props) {
    ...
    return(
        <FadeInDiv style={{width:'100%'}}>
            ...
            <div>
                    <br/>
                    <img className='submit_icon' id={'addEducation'} type='image' src={submitButton} alt={'addEducation'} width='45px' height='45px' onClick={() => props.addTestScore()}/>
                </div>   
            <div>
                <TestTable tableData={props.tableData} />
            </div>
        </FadeInDiv>
    )
}